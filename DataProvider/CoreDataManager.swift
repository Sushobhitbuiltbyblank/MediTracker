...
class CoreDataManager: NSObject {
    ...
    // MARK: - FetchRequest
    func getRequestForEntityName(entity: EntityName) -> NSFetchRequest<NSFetchRequestResult> {
    ...
    func getObjectFor(entity: EntityName, predicate: NSPredicate) -> NSManagedObject? {
        ...
        do {
            ...
            if let detail = results.first as? NSManagedObject {
                return detail
            } else {
                return nil
            }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        let modelURL = Bundle.main.url(forResource: "MediTracker", withExtension: "momd")!
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "SCMBase")
